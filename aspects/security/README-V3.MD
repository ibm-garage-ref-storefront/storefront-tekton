...
## b) The pipeline run now fails on stackrox 

    TODO

## c) Inspect the stackrox report for the base image

![Fail](../../images/ubi-stackrox-report.png?raw=true "Title")


## d) Inspect the stackrox report for the image that was build
