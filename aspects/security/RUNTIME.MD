...
**Note:** Martin/Sion: We need to check whether by default:
  - a) this policy is enabled
  - b) this policy is in enforcement mode or not... Otherwise we need to amend task as necessary
