...
oc apply -f $HERE/tekton-tasks/ibm-kabanero-java-test.yaml 
oc create -f $HERE/tekton-tasks/kabanero-spring-boot2.yaml
#oc create -f https://raw.githubusercontent.com/IBM/ibm-garage-tekton-tasks/main/tasks/3-img-scan-trivy.yaml
oc create -f $HERE/tekton-tasks/ibm-img-scan-trivy.yaml
